...
| 核心产品 | Nexis / nginx_merry / r_data_service | Nexis / nginx_merry / r_data_service / IM SDK |
| 强调能力 | 安全能力域广度、合规、风控 | 性能、并发、架构、多语言 |
| 行业覆盖 | 金融、政务、互联网 | 金融、政务、互联网（次要） |
| 资质 | CISSP | 无（Backend 不需要强调安全资质） |
| 职业主线终点 | AI 安全基础设施 | AI 基础设施 |

---

## 待确认问题

1. Summary 长度是否合适？（当前 v1 约 5 句，120–150 字）
2. Resume A 是否需要明确提及「Application Security Engineer」岗位词？
3. Resume B 是否需要加入「Team Lead」信号？
4. 两份 Summary 是否都要写「15 年系统研发经验」？还是一份写 15 年，另一份换角度？
5. 是否需要加入「开源项目（go-fast-waf / tcpstream）」信号？

确认后进入 Phase 5：Core Skills 设计。
